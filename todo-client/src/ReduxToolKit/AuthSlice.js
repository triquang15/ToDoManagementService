...
import { BASR_URL, api, setAuthHeader } from "../Utils/ApiUrl";


export const login = createAsyncThunk("auth/login", async (userData) => {
    try {
        const { data } = await axios.post(`${BASR_URL}/auth/signin`, userData)
...
export const register = createAsyncThunk("auth/register", async (userData) => {
    try {
        const { data } = await axios.post(`${BASR_URL}/auth/signup`, userData)
        localStorage.setItem("jwt", data.jwt)
